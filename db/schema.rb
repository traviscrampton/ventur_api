...
ActiveRecord::Schema.define(version: 2019_08_30_105157) do
  ...
  create_table "cycle_routes", force: :cascade do |t|
    ...
    t.text "included_activities", default: ""
  end

  create_table "distances", force: :cascade do |t|
    t.integer "distanceable_id"
    t.string "distanceable_type"
    t.decimal "kilometer_amount", precision: 8, scale: 2
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "distance_type", default: 0
    t.decimal "mile_amount", precision: 8, scale: 2
  end
  ...
  create_table "strava_auths", force: :cascade do |t|
